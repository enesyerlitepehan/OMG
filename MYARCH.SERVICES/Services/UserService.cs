...
namespace MYARCH.SERVICES.Services
{
    ...
    {
        private readonly IGenericRepository<User> _userRepository; //user ile ilgili veritabanı işlemleri yapmak için.
        ...
        {
            var result = _userRepository.GetAll().Where(p => p.Id == Id).SingleOrDefault(); //varsa getir yoksa default ifade ver
